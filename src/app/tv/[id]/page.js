...
import { FiStar, FiCalendar, FiTv, FiHeart, FiBookmark, FiPlay, FiArrowLeft, FiUsers, FiEye, FiClock, FiMonitor } from 'react-icons/fi';
      ...
      {show.similar?.results && show.similar.results.length > 0 && (
        <div className="bg-gradient-to-b from-black to-gray-900 py-20">
          <div className="max-w-7xl mx-auto px-8">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6">
              {show.similar.results.slice(0, 12).map((similarShow, index) => (
                <motion.div
                  key={similarShow.id}
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
